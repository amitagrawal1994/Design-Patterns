...
//concrete class - Actually intented to be accessed by end user
...
//proxy class
//Proxy class should inherit abstract base class
class HyderabadProxy : public DrivingLicenseAuthority
{
    ...
    public:
        ...
        //This function name and prototype should be same as original
        void issueDrivingLicense()
        {
            if(driverAge > 18)
            {
...
int main()
{
    ...
    authority->issueDrivingLicense(); // actual call by end user
